...
const Footer = () => {
  return (
    <section className=" py-13 bg-[#F7F7F7]">
      <div className="container mx-auto grid sm:grid-cols-2 lg:grid-cols-5  lg:px-9 ">
        <div className=" px-2 text-center  md:mt-6 lg:mt-6 lg:text-left lg:col-span-2">
        ...
        <div className="px-2  text-center my-8   lg:text-left  ">
      ...
      <div className=" flex flex-col  items-center md:flex-row md:justify-between px-19  mt-4 ">
        <h5 className="text-[rgba(30,40,51,0.57)] font-[500] text-[15px] 	">
          Copyright © 2020
        </h5>
        <div className="md:flex  gap-8  lg:me-33  ">
